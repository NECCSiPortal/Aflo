...
class Server(object):
    ...
    def __init__(self, threads=1000):
        ...
        try:
            ...
            # NOTE(flaper87): When running aflo-control,
            # (aflo's functional tests, for example)
            # setpgid fails with EPERM as aflo-control
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        langs = i18n.get_available_languages('aflo')
