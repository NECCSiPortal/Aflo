...
"""
Aflo Management Utility
"""

from __future__ import print_function

# FIXME(sirp): When we have aflo-admin we can consider merging this into it
# Perhaps for consistency with Nova, we would then rename aflo-admin ->
# aflo-manage (or the other way around)
...
def main():
    ...
    try:
        ...
        cfg_files = cfg.find_config_files(project='aflo', prog='aflo-api')
        cfg_files.extend(cfg.find_config_files(project='aflo',
                                               prog='aflo-manage'))
    ...
    except exception.ApiAppException as e:
